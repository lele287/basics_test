					...
					<scroll-view scroll-y :style="'height:' + scrollH+'px;'">
						...
						<view class="about-live-wrap">
							...
							<view class="alive-info">
								<rich-text :nodes="liveInfo.des"></rich-text>
							</view>
						</view>
		...
		methods: {
			...
			enterContent() {
				...
				uni.navigateTo({
					...
					url: '../content-detail/content-detail?name=' + this.liveInfo.name + '&add_time' + this.liveInfo.add_time +
						'&content' + this.liveInfo.content,
					fail: () => {
						uni.showToast({
							icon: 'none',
							title: '网络错误'
