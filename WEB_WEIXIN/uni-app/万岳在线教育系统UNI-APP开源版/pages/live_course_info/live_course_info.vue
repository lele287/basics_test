<template>
	<view class="app">
		<!-- #ifdef MP-WEIXIN -->
		<uni-nav-bar @clickLeft="backCourseList" left-icon="back" :border="false" title="详情" statusBar >
		...
		<!-- #ifndef MP-WEIXIN -->
		<uni-nav-bar @clickLeft="backCourseList" left-icon="back" :border="false" title="详情">
		...
		<view class="live_course_bg_wrap">
			<image class="live_course_img" :src="live_course_bg" mode=""></image>

			<template v-if="paytype == 2">
				<image @click="enterpasslive" class="play_tu" src="../../static/images/play_tu.png" mode=""></image>
			</template>
			<template v-else-if="paytype == 0">
				<image @click="enterlive" class="play_tu" src="../../static/images/play_tu.png" mode=""></image>
			</template>
			<template v-else-if="paytype == 1">
				<image @click="enterpaylive" class="play_tu" src="../../static/images/play_tu.png" mode=""></image>
			</template>
		</view>
		...
		methods: {
			...
			enterlive() {
				...
				uni.navigateTo({
					...
					url: '../live-info/testplay?liveuid=' + liveInfo.uid +
						'&courseid=' + liveInfo.id + '&lessonid=' + '',
				});
				// #endif
